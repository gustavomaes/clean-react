...
import { InvalidCredationsError, UnexpectedError } from '@/domain/errors'
...
describe('RemoteAuthentication', () => {
  ...
  test('should throw InvalidCredationsError if HttpPostClient returns 401', async () => {
    const { sut, httpPostClientSpy } = makeSut()
  ...
  test('should throw UnexectedError if HttpPostClient returns 400', async () => {
    const { sut, httpPostClientSpy } = makeSut()
  ...
  test('should throw UnexectedError if HttpPostClient returns 404', async () => {
    const { sut, httpPostClientSpy } = makeSut()
  ...
  test('should throw UnexectedError if HttpPostClient returns 500', async () => {
    const { sut, httpPostClientSpy } = makeSut()
